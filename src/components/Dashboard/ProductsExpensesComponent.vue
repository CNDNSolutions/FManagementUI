...
<template>
    <div title="Product expenses" class="flex flex-col justify-between rounded border-2 border-border-color bg-secondary/100 p-3 hover:bg-primary/10 cursor-pointer">
        <div class="flex justify-between">
            <div class="font-bold text-xl text-secondary-text">Products</div>
        ...
        <div title="Ratio of current costs to last months costs" v-bind:class="costs.lastMonth.amount > costs.currentMonth.amount ? ' *:text-emerald-500 ' : ' *:text-red-500'" class="flex items-start *:text-sm">
            <div>(</div>
